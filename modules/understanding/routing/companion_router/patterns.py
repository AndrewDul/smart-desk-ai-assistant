...
ACTION_TO_TOOL: dict[str, str] = {
    ...
    "time_query": "clock.time",
    "ask_date": "clock.date",
    "show_date": "clock.date",
    "date_query": "clock.date",
    "ask_day": "clock.day",
    "show_day": "clock.day",
    "day_query": "clock.day",
    "ask_month": "clock.month",
    "show_month": "clock.month",
    "month_query": "clock.month",
    "ask_year": "clock.year",
    "show_year": "clock.year",
    "year_query": "clock.year",
    "exit": "system.sleep",
...
GENERIC_KNOWLEDGE_PATTERNS = (
    ...
    r"\bwyjasnij\b",
    r"\bwyjaśnij\b",
    r"\bwyjasnij prostymi slowami\b",
    r"\bwyjaśnij prostymi słowami\b",
    r"\bwytlumacz\b",
    r"\bwytłumacz\b",
    r"\bopowiedz o\b",
    r"\bopowiedz krotko\b",
    r"\bopowiedz krótko\b",
    r"\bpowiedz mi czym\b",
)
