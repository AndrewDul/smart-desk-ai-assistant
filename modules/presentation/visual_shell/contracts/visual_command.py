...
class VisualCommandName(StrEnum):
    ...
    SHOW_TIME = "SHOW_TIME"
    SHOW_HELP = "SHOW_HELP"
    SHOW_MEMORY_GALLERY = "SHOW_MEMORY_GALLERY"
    SHOW_TIMER_COUNTDOWN = "SHOW_TIMER_COUNTDOWN"
    CLEAR_TIMER_COUNTDOWN = "CLEAR_TIMER_COUNTDOWN"
    SHOW_FEEDBACK = "SHOW_FEEDBACK"
    HIDE_FEEDBACK = "HIDE_FEEDBACK"
    FEEDBACK_LOG_APPEND = "FEEDBACK_LOG_APPEND"
    FEEDBACK_STATUS_UPDATE = "FEEDBACK_STATUS_UPDATE"
    FEEDBACK_VISION_FRAME = "FEEDBACK_VISION_FRAME"
