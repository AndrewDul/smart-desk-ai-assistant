...
class ActionFlowOrchestrator(
    ...
    ACTION_LABELS = {
        ...
        "show_self": ("pokazanie siebie", "show yourself"),
        "show_eyes": ("pokazanie oczu", "show eyes"),
        "show_face_contour": ("pokazanie twarzy", "show face"),
        "look_at_user": ("spojrzenie na użytkownika", "look at user"),
        "start_scanning": ("skanowanie otoczenia", "scan surroundings"),
