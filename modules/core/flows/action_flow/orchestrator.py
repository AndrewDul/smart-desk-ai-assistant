...
class ActionFlowOrchestrator(
    ...
    TOOL_TO_ACTION: dict[str, str] = {
        ...
        "visual_shell.show_time": "show_visual_time",
    ...
    ACTION_LABELS = {
        "help": ("pomoc", "help"),
        "feedback_on": ("uruchomienie trybu feedback", "start feedback mode"),
        "feedback_off": ("zamknięcie trybu feedback", "stop feedback mode"),
        "status": ("status", "status"),
        "debug_status": ("status debug", "debug status"),
        "calculate": ("szybkie liczenie", "quick calculation"),
        ...
        "show_visual_time": ("pokazanie godziny na ekranie", "show time on screen"),
        "show_visual_date": ("pokazanie daty na ekranie", "show date on screen"),
        ...
        "drive_mode_stop": ("zatrzymanie bazy", "stop mobile base"),
