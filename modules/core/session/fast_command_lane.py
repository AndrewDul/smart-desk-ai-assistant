...
class FastCommandLane:
    ...
    def _match_simple_action(normalized_text: str) -> str:
        ...
        direct_map = {
            ...
            "powiedz mi godzine": "ask_time",
            "powiedz mi godzinę": "ask_time",
            "powiedz ktora godzina": "ask_time",
            "powiedz która godzina": "ask_time",
            "czas": "ask_time",
            "show me the time": "show_visual_time",
            "show the time": "show_visual_time",
            "display the time": "show_visual_time",
            "show clock": "show_visual_time",
            "show me the clock": "show_visual_time",
            "pokaż mi czas": "show_visual_time",
            "pokaz mi czas": "show_visual_time",
            "pokaż czas": "show_visual_time",
            "pokaz czas": "show_visual_time",
            "pokaż godzinę": "show_visual_time",
            "pokaz godzine": "show_visual_time",
            "wyświetl godzinę": "show_visual_time",
            "wyswietl godzine": "show_visual_time",
            "pokaż zegar": "show_visual_time",
            "pokaz zegar": "show_visual_time",
            "date": "ask_date",
            "today date": "ask_date",
            "data": "ask_date",
            "jaka data": "ask_date",
    ...
    def _tool_name_for_action(action: str) -> str:
        mapping = {
            ...
            "ask_time": "clock.time",
            "show_time": "visual_shell.show_time",
            "show_visual_time": "visual_shell.show_time",
            "ask_date": "clock.date",
