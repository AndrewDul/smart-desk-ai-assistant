...
|---|---|---:|---:|---|---|---|
| READY | `assistant.help` | 7 | 11 | True | True | grammar + allowlist + execution spec present |
| READY | `assistant.identity` | 3 | 1 | True | True | grammar + allowlist + execution spec present |
| READY | `mobile_base.drive_mode` | 9 | 12 | True | True | grammar + allowlist + execution spec present |
| READY | `mobile_base.stop` | 5 | 5 | True | True | grammar + allowlist + execution spec present |
...
| READY | `visual_shell.show_date` | 1 | 3 | True | True | grammar + allowlist + execution spec present |
...
- No target fast-line gaps detected by this static audit.
