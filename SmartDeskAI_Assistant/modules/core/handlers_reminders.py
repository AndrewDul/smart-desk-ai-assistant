...
def handle_reminders_list(assistant, lang: str) -> bool:
    ...
    _speak_and_remember_localized(
        ...
        action="reminders_list",
        extra_metadata={"count": total_count, "pending_count": pending_count},
    )
    return True
...
def handle_reminder_delete(assistant, result, lang: str) -> bool:
    ...
    if reminder is None:
        ...
        _speak_and_remember_localized(
            ...
            extra_metadata={"phase": "not_found"},
        )
        return True
